...
DEPENDENCY RECORDED (2026-09-02). This change stays PARKED and depends, in order, on `freeze-the-first-observed-worktree-before-writing` and `never-release-a-lock-a-pending-write-still-owns`; they own F001 and F003 as separate invariants, while WT-012.6 retains blueprint and final integration ownership.
