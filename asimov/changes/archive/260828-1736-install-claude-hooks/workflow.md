...
- Superseded by `install-claude-hooks-v1`: archived incomplete after the rejected generalized ledger/ownership lifecycle failed to converge. Its specification delta remains unapplied.
