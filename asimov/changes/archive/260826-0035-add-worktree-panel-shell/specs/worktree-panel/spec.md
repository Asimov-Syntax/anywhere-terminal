...
An action a row cannot perform SHALL be absent from its context menu rather than present and disabled, because a disabled item claims the action exists here and is merely unavailable.
