...
**The undo removes the entry it created, unconditionally, and the link's state does not gate that
removal.** Rounds 2 through 6 each closed one mutation boundary of the withdrawal and the next round
