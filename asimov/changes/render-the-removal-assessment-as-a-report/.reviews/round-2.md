...
- Status: accepted — open, persists from round 1
- Triage: Deliberately not fixed in the implementation loop because either remedy changes product scope; no user-granted risk acceptance exists, so it remains gating.
