...
- [x] 2_2 Open the drawer from a selection and dismiss it explicitly — verified: pnpm exec vitest run 'src/webview/worktree/WorktreeController.inspector.test.ts' && pnpm run check-types && pnpm run test:unit exit 0
  - **Deps**: 2_1, 1_5
