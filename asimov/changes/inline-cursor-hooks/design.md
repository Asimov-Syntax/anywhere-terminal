...
| Shell ambient state | Exported functions or xtrace can hijack utilities or expose payload | D1 disables xtrace/errexit and removes invoked function names; D2 states the pre-command-code boundary |
