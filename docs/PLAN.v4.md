...
| **Amended** | 2026-08-29, by DESIGN.md § 9 D27. The last clause is narrowed to: *where activity is output-inferred*, both surfaces run the one shared rule and hold the same activity value. Presentation equivalence is not claimed, and hook-backed activity was already outside it — see [worktree-activity-ceiling.md](design/worktree-activity-ceiling.md) § 4 |
| **Status** | done |
