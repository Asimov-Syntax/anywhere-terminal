...
export const INVARIANTS: readonly InvariantRow[] = [
  ...
  },
  {
    ...
    status: "uncovered",
    reason: "cross-layer \u2014 hook event through reducer, evidence store, and projection (task 2_1)",
  },
  {
    id: "I7",
    ...
    status: "uncovered",
    reason: "cross-layer \u2014 runtime disposal through evidence expiry to identity fallback (task 2_1)",
  },
  {
    id: "I8",
  ...
  },
  {
    ...
    status: "uncovered",
    reason: "cross-layer \u2014 I9 names four boundaries; each existing test covers one (task 2_1)",
  },
  {
    id: "I10",
  ...
  },
  {
    ...
    status: "uncovered",
    reason: "cross-layer \u2014 menu, dialog, host, and execution-time re-evaluation (task 2_1)",
  },
  {
    id: "I15",
    ...
    status: "uncovered",
    reason: "cross-layer \u2014 mutation service through forced rebuild to the rendered verdict (task 2_1)",
  },
  {
    id: "I16",
